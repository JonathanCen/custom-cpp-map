...
int main() {
  ...
  
  {
    ...
    ascendingInsert<myMap::Map<int,int>>(1000);
    ascendingInsert<myMap::Map<int,int>>(10000);
    ascendingInsert<myMap::Map<int,int>>(100000);
    ascendingInsert<myMap::Map<int,int>>(1000000);
    ascendingInsert<myMap::Map<int,int>>(10000000);
    dispTestName("Ascending insert", w);
    ascendingInsert<myMap::StdMapWrapper<int,int>>(1000);
    ascendingInsert<myMap::StdMapWrapper<int,int>>(10000);
    ascendingInsert<myMap::StdMapWrapper<int,int>>(100000);
    ascendingInsert<myMap::StdMapWrapper<int,int>>(1000000);
    ascendingInsert<myMap::StdMapWrapper<int,int>>(10000000);
  }
  
  {
    dispTestName("Descending insert", m);
    descendingInsert<myMap::Map<int,int>>(1000);
    descendingInsert<myMap::Map<int,int>>(10000);
    descendingInsert<myMap::Map<int,int>>(100000);
    descendingInsert<myMap::Map<int,int>>(1000000);
    descendingInsert<myMap::Map<int,int>>(10000000);
    dispTestName("Descending insert", w);
    descendingInsert<myMap::StdMapWrapper<int,int>>(1000);
    descendingInsert<myMap::StdMapWrapper<int,int>>(10000);
    descendingInsert<myMap::StdMapWrapper<int,int>>(100000);
    descendingInsert<myMap::StdMapWrapper<int,int>>(1000000);
    descendingInsert<myMap::StdMapWrapper<int,int>>(10000000);
  }
  
  {
    dispTestName("Delete test", m);
    deleteTest<myMap::Map<int,int>>();
    dispTestName("Delete test", w);
    deleteTest<myMap::StdMapWrapper<int,int>>();
  }
  
  {
    dispTestName("Find test", m);
    findTest<myMap::Map<int,int>>();
    dispTestName("Find test", w);
    findTest<myMap::StdMapWrapper<int,int>>();
  }
  ...
  */
  {
    ...
    iterationTest<myMap::Map<int,int>>(10000);
    iterationTest<myMap::Map<int,int>>(20000);
    iterationTest<myMap::Map<int,int>>(40000);
    iterationTest<myMap::Map<int,int>>(80000);
    iterationTest<myMap::Map<int,int>>(160000);
    iterationTest<myMap::Map<int,int>>(320000);
    iterationTest<myMap::Map<int,int>>(640000);
    iterationTest<myMap::Map<int,int>>(1280000);
    iterationTest<myMap::Map<int,int>>(2560000);
    iterationTest<myMap::Map<int,int>>(5120000);
    ...
    iterationTest<myMap::Map<int,int>>(600000000);
#endif
    dispTestName("Iteration test", w);
    iterationTest<myMap::StdMapWrapper<int,int>>(10000);
    iterationTest<myMap::StdMapWrapper<int,int>>(20000);
    iterationTest<myMap::StdMapWrapper<int,int>>(40000);
    iterationTest<myMap::StdMapWrapper<int,int>>(80000);
    iterationTest<myMap::StdMapWrapper<int,int>>(160000);
    iterationTest<myMap::StdMapWrapper<int,int>>(320000);
    iterationTest<myMap::StdMapWrapper<int,int>>(640000);
    iterationTest<myMap::StdMapWrapper<int,int>>(1280000);
    iterationTest<myMap::StdMapWrapper<int,int>>(5120000);
#if DO_BIG_ITERATION_TEST
  //Optional test. This is more ram than the remote machines have and will likely take a long time to run.
  iterationTest<myMap::Map<int,int>>(600000000);
#endif
  ...
  
  {
    ...
    copyTest<myMap::Map<int,int>>(10000);
    copyTest<myMap::Map<int,int>>(100000);
    copyTest<myMap::Map<int,int>>(1000000);
    copyTest<myMap::Map<int,int>>(10000000);
    dispTestName("Copy test", w);
    copyTest<myMap::StdMapWrapper<int,int>>(10000);
    copyTest<myMap::StdMapWrapper<int,int>>(100000);
    copyTest<myMap::StdMapWrapper<int,int>>(1000000);
    copyTest<myMap::StdMapWrapper<int,int>>(10000000);
  }

  {
    dispTestName("Reverse Iteration test", m);
    rIterationTest<myMap::Map<int,int>>(10000);
    rIterationTest<myMap::Map<int,int>>(20000);
    rIterationTest<myMap::Map<int,int>>(40000);
    rIterationTest<myMap::Map<int,int>>(80000);
    rIterationTest<myMap::Map<int,int>>(160000);
    rIterationTest<myMap::Map<int,int>>(320000);
    rIterationTest<myMap::Map<int,int>>(640000);
    rIterationTest<myMap::Map<int,int>>(1280000);
    rIterationTest<myMap::Map<int,int>>(2560000);
    rIterationTest<myMap::Map<int,int>>(5120000);
  }
 
  {
    dispTestName("Reverse Iteration test", w);
    rIterationTest<myMap::StdMapWrapper<int,int>>(10000);
    rIterationTest<myMap::StdMapWrapper<int,int>>(20000);
    rIterationTest<myMap::StdMapWrapper<int,int>>(40000);
    rIterationTest<myMap::StdMapWrapper<int,int>>(80000);
    rIterationTest<myMap::StdMapWrapper<int,int>>(160000);
    rIterationTest<myMap::StdMapWrapper<int,int>>(320000);
    rIterationTest<myMap::StdMapWrapper<int,int>>(640000);
    rIterationTest<myMap::StdMapWrapper<int,int>>(1280000);
    rIterationTest<myMap::StdMapWrapper<int,int>>(2560000);
    rIterationTest<myMap::StdMapWrapper<int,int>>(5120000);
  }
